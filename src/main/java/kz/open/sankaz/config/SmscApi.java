...
public class SmscApi {
	...
	public SmscApi(String login, String password) {
		SMSC_LOGIN    = login;
		SMSC_PASSWORD = password;
	}

	public SmscApi(String login, String password, String charset) {
		SMSC_LOGIN    = login;
		SMSC_PASSWORD = password;
		SMSC_CHARSET  = charset;
	}

	public SmscApi(String login, String password, String charset, boolean debug) {
		SMSC_LOGIN    = login;
		SMSC_PASSWORD = password;
		SMSC_CHARSET  = charset;
		SMSC_DEBUG    = debug;
...
/*
		Smsc sd = new Smsc();
		// or
		Smsc sd = new Smsc("login", "3cc3621995712fbe6bdb6954d82ac8704e0c571b");
