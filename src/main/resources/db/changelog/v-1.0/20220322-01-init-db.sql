...
alter table public.booking
    add constraint UK_ECOM_ORDER_ID unique (ecom_order_id);
alter table public.city
    add constraint UK_p738egrkomomgourst3hqfipb unique (code);
alter table public.company_category
    add constraint UK_irrd8l4f2wtj4pd263qxkcoda unique (code);
alter table public.gender
    add constraint UK_mxvfcsf1euhi5hsw1uecvke7b unique (code);
alter table public.notification_template
    add constraint UK_78ljxu1rtyj29qj8a3bao9bfx unique (code);
alter table public.organization
    add constraint UK_t4bamosb7eleheafmlcalbhjf unique (email);
alter table public.organization
    add constraint UK_6xmmhtj3oxb3xv5pmwey8q98o unique (iban);
alter table public.organization
    add constraint UK_nk7pj2mrxhl33pqk8l3cifn5x unique (iin);
alter table public.organization
...
alter table public.sec_role
    add constraint UK_328v0xhgur113t0ak61ieyp8n unique (name);
alter table public.sec_user
    add constraint UK_numjsbs0wblvnqi7po8eyeo6y unique (email);
alter table public.sec_user
    add constraint UK_8s0loc6vmiu65wedpybnydh0b unique (tel_number);
alter table public.sec_user
    add constraint UK_5ctbdrlf3eismye20vsdtk8w8 unique (username);
alter table public.service_category
    add constraint UK_mr019mf8foyex0jdkjtaet7s0 unique (code);
alter table public.user_device_token
    add constraint UK_dd839ilume1jlv5l6q0wl4ave unique (token);
alter table public.user_favorites
    add constraint UK_USER_ID_AND_SAN_ID unique (user_id, san_id);
alter table public.booking
    add constraint BOOKING_ROOM_FK foreign key (room_id) references public.room;
alter table public.booking
    add constraint BOOKING_USER_FK foreign key (user_id) references public.sec_user;
alter table public.booking_history
    add constraint BOOKING_HISTORY_BOOKING_FK foreign key (booking_id) references public.booking;
alter table public.organization
    add constraint ORGANIZATION_COMPANY_CATEGORY_FK foreign key (company_category_id) references public.company_category;
alter table public.organization
    add constraint ORGANIZATION_USER_FK foreign key (user_id) references public.sec_user;
alter table public.organization_pics
    add constraint ORGANIZATION_PICS_FILE_FK foreign key (file_id) references public.sys_file;
alter table public.organization_pics
    add constraint ORGANIZATION_PICS_ORGANIZATION_FK foreign key (organization_id) references public.organization;
alter table public.review
    add constraint MESSAGE_USER_FK foreign key (user_id) references public.sec_user;
alter table public.review
    add constraint REVIEW_PARENT_FK foreign key (parent_id) references public.review;
alter table public.review
...
alter table public.room_pics
    add constraint ROOM_PICS_ROOM_FK foreign key (room_id) references public.room;
alter table public.san
    add constraint SAN_CITY_FK foreign key (city_id) references public.city;
alter table public.san
    add constraint SAN_ORG_FK foreign key (org_id) references public.organization;
alter table public.san
    add constraint SAN_TYPE_FK foreign key (san_type_id) references public.san_type;
alter table public.san_pics
    add constraint SAN_PICS_PIC_FK foreign key (pic_id) references public.sys_file;
alter table public.san_pics
    add constraint SAN_PICS_SAN_FK foreign key (san_id) references public.san;
alter table public.san_tel_numbers
    add constraint SAN_TEL_NUMBERS_NUMBER_FK foreign key (tel_number_id) references public.tel_number;
alter table public.san_tel_numbers
    add constraint SAN_TEL_NUMBERS_SAN_FK foreign key (san_id) references public.san;
alter table public.sec_user
    add constraint SEC_USER_CITY_FK foreign key (city_id) references public.city;
alter table public.sec_user
    add constraint SEC_USER_GENDER_FK foreign key (gender_id) references public.gender;
alter table public.sec_user
    add constraint SEC_USER_PIC_FK foreign key (pic_id) references public.sys_file;
alter table public.sec_user_roles
    add constraint FKabm55itj3htl8yno424528wi8 foreign key (role_id) references public.sec_role;
alter table public.sec_user_roles
    add constraint FKmu39wf2qaxcmq8e5cqtmv8ofv foreign key (user_id) references public.sec_user;
alter table public.sec_user_token
    add constraint TOKEN_USER_FK foreign key (user_id) references public.sec_user;
alter table public.stock
    add constraint STOCK_SAN_FK foreign key (san_id) references public.san;
alter table public.user_device_token
    add constraint TOKEN_USER_FK foreign key (user_id) references public.sec_user;
alter table public.user_favorites
    add constraint FAV_SAN_FK foreign key (san_id) references public.san;
alter table public.user_favorites
    add constraint FAV_USER_FK foreign key (user_id) references public.sec_user;
alter table public.user_notification
    add constraint NOTIFICATION_BOOK_FK foreign key (book_id) references public.booking_history;
alter table public.user_notification
    add constraint NOTIFICATION_STOCK_FK foreign key (stock_id) references public.stock;
alter table public.user_notification
    add constraint NOTIFICATION_USER_FK foreign key (user_id) references public.sec_user;
...
(id, code, description, "name", description_kz, name_kz)
VALUES(nextval('public.city_seq'), 'ALM', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.', 'Алматы', NULL, NULL),
       (nextval('public.city_seq'), 'AST', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.', 'Астана', NULL, NULL);
...
VALUES(nextval('public.san_seq'), 'Талгар, ул.Бокейханов, д.17', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.', NULL, NULL, NULL, 'Ақбұлак', NULL, 1, 1, 1),
       ...
       (nextval('public.san_seq'), 'Талгар, ул.Есенберлин, д.', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.', NULL, NULL, NULL, 'Шымбұлак', NULL, 2, 3, 2),
...
(id, adults_count, approved_date, booking_date, cancelled_date, children_count, end_date, first_name, last_name, paid_date, start_date, status, sum_price, tel_number, room_id, user_id, ecom_order_id)
VALUES(nextval('public.booking_seq'), 1, NULL, '2022-03-22 20:10:14.000', NULL, 0, '2022-03-26 00:00:00.000', 'Алмат', 'Рахметолла', NULL, '2022-03-23 00:00:00.000', 'WAITING', 15000.00, '+77081997727', 1, NULL, 'ecom_1'),
(nextval('public.booking_seq'), 2, NULL, '2022-03-22 20:10:14.000', NULL, 0, '2022-03-27 00:00:00.000', 'Бекзат', 'Серкебай', NULL, '2022-03-23 00:00:00.000', 'WAITING', 15000.00, '+77081997777', 1, NULL, 'ecom_2'),
(nextval('public.booking_seq'), 1, NULL, '2022-03-22 20:10:14.000', '2022-03-22 20:10:14.000', 0, '2022-03-27 00:00:00.000', 'Асан', 'Пердешов', NULL, '2022-03-25 00:00:00.000', 'CANCELLED', 3000.00, '+77028649054', 1, NULL, 'ecom_3'),
(nextval('public.booking_seq'), 2, NULL, '2022-03-22 20:10:14.000', '2022-03-22 20:10:14.000', 0, '2022-03-29 00:00:00.000', 'Болат', 'Назарбаев', NULL, '2022-03-26 00:00:00.000', 'CANCELLED', 40000.00, '+77021000000', 1, NULL, 'ecom_4'),
(nextval('public.booking_seq'), 1, '2022-03-22 20:10:14.000', '2022-03-22 20:10:14.000', NULL, 0, '2022-03-31 00:00:00.000', 'Мейрамбек', 'Бесбаев', NULL, '2022-03-27 00:00:00.000', 'APPROVED', 60000.00, '+77777777778', 3, NULL, 'ecom_5'),
(nextval('public.booking_seq'), 2, NULL, '2022-03-22 20:10:14.000', NULL, 0, '2022-04-02 00:00:00.000', 'Заттыбек', 'Көпболсынұлы', '2022-03-28 00:00:00.000', '2022-03-28 00:00:00.000', 'PAID', 25000.00, '+77081111111', 3, NULL, 'ecom_6'),
(nextval('public.booking_seq'), 1, '2022-03-22 20:10:14.000', '2022-03-22 20:10:14.000', NULL, 0, '2022-04-04 00:00:00.000', 'Дуа', 'Липа', NULL, '2022-03-29 00:00:00.000', 'APPROVED', 89000.00, '+77070000007', 4, NULL, 'ecom_7'),
(nextval('public.booking_seq'), 2, NULL, '2022-03-22 20:10:14.000', NULL, 0, '2022-04-06 00:00:00.000', 'Қасым-Жомарт', 'Тоқаев', '2022-03-30 00:00:00.000', '2022-03-30 00:00:00.000', 'PAID', 65000.00, '+77777777777', 4, NULL, 'ecom_8'),
(nextval('public.booking_seq'), 1, '2022-03-22 20:10:14.000', '2022-03-22 20:10:14.000', NULL, 0, '2022-04-08 00:00:00.000', 'Евгений', 'Поносенков', NULL, '2022-03-31 00:00:00.000', 'APPROVED', 51000.00, '+77055555555', 5, NULL, 'ecom_9'),
(nextval('public.booking_seq'), 2, NULL, '2022-03-22 20:10:14.000', NULL, 0, '2022-04-10 00:00:00.000', 'Владимир', 'Путин', '2022-03-30 00:00:00.000', '2022-03-30 00:00:00.000', 'PAID', 109000.00, '+77012332233', 5, NULL, 'ecom_10'),
(nextval('public.booking_seq'), 3, NULL, '2022-03-22 20:10:14.000', NULL, 0, '2022-04-12 00:00:00.000', 'Владимир', 'Зеленский', '2022-03-31 00:00:00.000', '2022-03-31 00:00:00.000', 'PAID', 10000.00, '+77012332244', 2, NULL, 'ecom_11');